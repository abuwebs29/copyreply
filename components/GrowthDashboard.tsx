  ...
  return (
    <div className="container admin-dashboard">
      ...
      <section className="admin-panel admin-opportunity">
        ...
        <div className="admin-links"><Link href="/admin/content-factory">Open Content Factory</Link><Link href="/search">Test search</Link><Link href="/studio">Test Studio</Link><Link href="/guides">Review guides</Link></div>
      </section>
    </div>
  );
}
